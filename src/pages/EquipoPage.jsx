...
// // // RUTA CORREGIDA/VERIFICADA según tu estructura:
...
// //     setLoading(true);
// //     try {
// //       // getEquipos ahora devuelve los datos del cliente aplanados
...
// //     // Refrescar balances y equipos al cerrar el modal por si hubo pagos
// //     fetchEquipos();
// //   };
...
// //                             </td>
// //                             <td
// //                               className={`px-6 py-4 whitespace-nowrap text-sm font-semibold text-right ${data.totalBalance >= 0 ? "text-emerald-400" : "text-red-400"
// //                                 }`}
// //                             >
...
// //                                   </div>
// //                                   <span className={`px-3 py-1 text-xs font-bold rounded-full whitespace-nowrap ${estadoNombre.includes('Finalizado') ? 'bg-emerald-600/20 text-emerald-400' :
...
// //                                 {/* 5. ACCIONES (CORREGIDO: Grid responsivo y alineación) */}
// //                                 <div className="pt-4 border-t border-neutral-800">
// //                                   {/* Utilizamos:
// //       - flex gap-2: para dispositivos móviles (los botones se apilan si no caben o se muestran en una fila flexible).
// //       - md:grid md:grid-cols-4: para pantallas medianas (desktop), usamos una cuadrícula de 4 columnas.
// //     */}
// //                                   <div className="flex gap-2 justify-end md:grid md:grid-cols-4">

// //                                     {/* BOTÓN DE HISTORIAL CLIENTE (Columna 1) */}
// //                                     {eq.cliente_id && (
// //                                       <button
...
// import AlertNotification from "../components/Alerta/AlertNotification.jsx";
// import HistorialPagosModal from "../components/Pagos/HistorialPagosModal.jsx";
// // ⬇️ NUEVO: modal de orden de trabajo en lugar de EquipoModal
// import NuevaOrdenTrabajoModal from "../components/OrdenTrabajo/NuevaOrdenTrabajoModal.jsx";
// // EquipoModal se sigue usando solo para MODIFICAR datos del equipo
// import EquipoModal from "../components/Equipo/EquipoModal.jsx";
...
//   // ── modales ──
//   // NuevaOrdenTrabajoModal: para crear una nueva OT (flujo 3 pasos)
//   const [isNuevaOTOpen, setIsNuevaOTOpen] = useState(false);
//   // EquipoModal: solo para MODIFICAR datos del equipo
...
//   // ⬇️ CAMBIO: botón "Agregar" abre NuevaOrdenTrabajoModal
//   const handleAgregar = () => setIsNuevaOTOpen(true);

//   // EquipoModal solo para modificar datos del equipo (marca, modelo, tipo, imei)
//   const handleModificar = (equipo) => {
//     setEquipoSeleccionado(equipo);
...
//   // handleSubmit: solo para MODIFICAR el equipo (sin problema/patron/password)
...
//             <div className="space-y-4">
//               {/* ⬇️ CAMBIO: botón llama a handleAgregar → abre NuevaOrdenTrabajoModal */}
...
//                             const balanceNeto    = balance?.balance_final ?? 0;
//                             const estadoNombre   = getNombreEstado(eq.estado_id);
//                             const clienteNombre  = `${eq.cliente_nombre || "Anónimo"} ${eq.cliente_apellido || ""}`;
...
//                                     </p>
//                                     <p className="text-xs font-light text-neutral-400 uppercase">{eq.tipo} | ID: {eq.id}</p>
//                                     {eq.imei && <p className="text-xs text-neutral-500">IMEI: {eq.imei}</p>}
//                                   </div>
//                                   <span className={`px-3 py-1 text-xs font-bold rounded-full whitespace-nowrap ${estadoNombre.includes("Finalizado") ? "bg-emerald-600/20 text-emerald-400" : estadoNombre.includes("Pendiente") ? "bg-yellow-600/20 text-yellow-400" : "bg-neutral-700/20 text-neutral-300"}`}>
//                                     {estadoNombre}
//                                   </span>
//                                 </div>

//                                 <div className="space-y-2">
//                                   {/* ⬇️ CAMBIO: mostramos falla_reportada de la última OT */}
//                                   <div className="flex items-start gap-2 text-sm">
//                                     <span className="text-red-400/80 mt-0.5 flex-shrink-0"><IconAlertTriangle /></span>
//                                     <div className="grid">
//                                       <span className="text-neutral-300 font-semibold leading-none">Última falla:</span>
//                                       <span className="font-light text-neutral-400 text-xs leading-tight line-clamp-3">
//                                         {eq.ultima_falla || eq.falla_reportada || "Sin registro"}
//                                       </span>
//                                     </div>
//                                   </div>
//                                   <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-neutral-400 text-xs pt-1 border-t border-neutral-800/50">
...
//                                       className="bg-neutral-700 hover:bg-neutral-600 text-white w-full px-2 py-1 rounded-lg text-xs transition-colors text-center">
//                                       Presupuestos
//                                     </Link>
...
//         {/* ⬇️ NUEVO: modal de nueva OT (flujo 3 pasos) */}
