...
// ⬇️ FIX TIMEZONE: convierte "2026-09-01" → "2026-09-01T12:00:00"
// Guardar a mediodía evita que UTC-3 tire la fecha al día anterior
const fechaLocalSegura = (fechaStr) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createOrdenTrabajo({
        ...
        patron:          formOT.patron      || null,
        diagnostico:     formOT.diagnostico || null,
        // ⬇️ FIX TIMEZONE: enviamos mediodía para evitar desfase UTC-3
        fecha_ingreso:   fechaLocalSegura(formOT.fecha_ingreso),
        estado_id:       Number(formOT.estado_id),
      });
