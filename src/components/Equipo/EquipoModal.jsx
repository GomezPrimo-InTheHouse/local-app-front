...
//   // Cargar clientes y estados desde la API
...
//   // Si ya viene en formato YYYY-MM-DD → devolver directo
//   if (/^\d{4}-\d{2}-\d{2}$/.test(fecha)) {
//     return fecha;
//   }

//   // Si viene como YYYY-MM-DD HH:mm:ss → recortar la parte de la hora
//   if (/^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}$/.test(fecha)) {
//     return fecha.split(" ")[0];
//   }

//   // Si viene como ISO (ej: 2025-08-18T00:00:00.000Z)
//   const d = new Date(fecha);
//   if (!isNaN(d)) {
//     // 👇 Evitamos el desfase horario usando la fecha local
